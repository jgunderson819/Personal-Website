...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <nav>
        <a href="https://www.linkedin.com/in/jeff-gunderson-15b203196"
          >LinkedIn</a
        >
        <a href="https://github.com/jgunderson819">Github</a>
      </nav>
    </header>
    ...
    <section ID="Contact-info">
      <h2>Contact Info</h2>
      <ul>
        <li><strong>Email:</strong> <a href="#">jgunderson819@gmail.com</a></li>
        <br />
        <li><strong>Cell:</strong> <a href="#">612-490-0785</a></li>
      </ul>
    </section>
